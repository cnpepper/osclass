        ...
        <div class="container">
            ...
            <div id="sidebar">
                <div class="list-group panel">
                    ...
                    <div class="child collapse" id="<?php echo $key; ?>">
                        ...
                        <a href="javascript:;" data-id="<?php echo $api['id']; ?>" class="list-group-item"><?php echo $api['title']; ?>
                            <span class="tag">
                                <?php if($api['needRight']): ?>
                                    <span class="label label-danger pull-right">鉴</span>
                                <?php endif; if($api['needLogin']): ?>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" id="heading-<?php echo $api['id']; ?>">
                        <h4 class="panel-title">
                            <span class="label <?php echo $api['methodLabel']; ?>"><?php echo strtoupper($api['method']); ?></span>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="info<?php echo $api['id']; ?>">
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading"><strong><?php echo $lang['Authorization']; ?></strong></div>
                                        <div class="panel-body">
                                            <table class="table table-hover">
                                                <tbody>
                                                <tr>
                                                    <td><?php echo $lang['NeedLogin']; ?></td>
                                                    <td><?php echo !empty($api['needLogin'])?'是':'否'; ?></td>
                                                </tr>
                                                <tr>
                                                    <td><?php echo $lang['NeedRight']; ?></td>
                                                    <td><?php echo !empty($api['needRight'])?'是':'否'; ?></td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                ...
                                <div class="tab-pane" id="sandbox<?php echo $api['id']; ?>">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <?php endif; ?>
                                            <div class="panel panel-default">
                                                <div class="panel-heading"><strong><?php echo $lang['Parameters']; ?></strong>
            ...
            <div class="row mt0 footer">
                ...
                <div class="col-md-6" align="right">
                    Generated on <?php echo date('Y-m-d H:i:s'); ?> <a href="./" target="_blank"><?php echo $config['sitename']; ?></a>
                </div>
            </div>
